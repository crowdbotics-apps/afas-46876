"""
Django settings for afas_46876 project.
...
WSGI_APPLICATION = 'afas_46876.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "afas_46876 API",
    "DESCRIPTION": "API documentation for afas_46876 App",
    "VERSION": "v1",
}
